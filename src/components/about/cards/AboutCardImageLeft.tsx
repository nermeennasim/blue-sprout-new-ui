// components/about/cards/AboutCardImageLeft.tsx
import React from "react";
import { useTheme } from "../../../context/ThemeContext";

interface AboutCardImageLeftProps {
	title: string;
	description: string;
	imageUrl: string;
	imageAlt?: string;
...
export const AboutCardImageLeft: React.FC<AboutCardImageLeftProps> = ({
	title,
	description,
	imageUrl,
	imageAlt = "",
			...
			<div className="lg:w-1/2">
				<div className="relative transform hover:scale-105 hover:-rotate-1 transition-all duration-700 ease-out">
					<div
						...
						style={{
							background: `linear-gradient(45deg, ${accent}, ${theme.accent})`,
							padding: "4px",
						}}>
